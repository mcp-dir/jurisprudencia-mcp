...
description: Pesquisa de jurisprudência brasileira em 17 tribunais (STF, STJ, TST, TRF3, TRF4, CARF e onze tribunais de justiça estaduais): acórdãos, decisões e súmulas por termo ou tese, com o trecho que casou a busca, o link oficial e leitura do inteiro teor quando disponível. Use sempre que o usuário pedir precedente, jurisprudência, súmula, entendimento de tribunal ou 'o que os tribunais decidem sobre X'. Restrinja por tribunal quando ele indicar onde procurar. Zero resultado costuma ser vocabulário, não ausência: tente os termos alternativos que a resposta sugere antes de afirmar que a tese não existe, e nunca trate aviso de indisponibilidade como inexistência. Grátis, sem login. Orquestra jurisprudencia_buscar, jurisprudencia_sumulas e jurisprudencia_documento do servidor remoto em https://api.mcp.ai/p_jurisprudencia.
---
